package com.iii._16_.FAQ.controller;
...
public class MemberFAQController {
	...
	public String getProductId(Map<String, Object> map, @ModelAttribute("MemberBean") MemberBean mb,
			@ModelAttribute("MemberFAQBean") MemberFAQBean faqb, HttpSession session) {
...
//	}
	...
	// MemberFAQBean bean2 = new MemberFAQBean(100, topic, id, mailbox, name, telp,
	// addr, report, titlee, ts, fileName, blob);
